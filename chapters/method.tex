...
The node subpub is launched with a file called "cmd\_vel\_subpub\_v1.py" from the "tb\_cpp" package\ref{method::tb3_cpp_pkg_explained}. Has three main components a subscriber, publisher and array. When "cmd\_vel\_subpub\_v1.py" is started it sets initial self.i, self.delay 
 
        self.i = 0
        self.delay = 9
        self.submsg = Twist() 
        self.array_linear_x = [0.25] * self.delay 
